...
DROP POLICY IF EXISTS "Admin can manage all contributions" ON contributionanti_nutrients;
DROP POLICY IF EXISTS "Users can view contributions" ON contributionanti_nutrients;
DROP POLICY IF EXISTS "Admin can manage all private contributions" ON contributionanti_nutrients_private;
DROP POLICY IF EXISTS "Users can view their own private contributions" ON contributionanti_nutrients_private;
...
-- Insert sample data for public flours if not already present
...
WHERE NOT EXISTS (
  ...
  WHERE contributionanti_nutrients.flour_id = flours.id
);

-- Insert sample data for enterprise flours if not already present
INSERT INTO contributionanti_nutrients (
  flour_id,
  contribution_anti_nutrientsyall,
  anti_nutrients_total_contri
