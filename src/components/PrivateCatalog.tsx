...
function PrivateCatalog() {
    ...
    try {
      ...
      if (floursData) {
        ...
        const { data: contributionsData, error: contributionsError } = await supabase
          .from('contributionanti_nutrients_private')
          .select('*')
  ...
  const handleFlourUpdate = async (updatedFlour: Flour) => {
    try {
      ...
      throw error; // Re-throw to be handled by the EditFlourDetails component
    }
  };
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
            ...
            <div key={flour.id} className="bg-white rounded-lg shadow-md overflow-hidden hover:shadow-lg transition-shadow">
              ...
              <div className="p-4">
                ...
                <div className="mt-3 space-y-2">
                  <PropertyBar label="Protéines" value={flour.nutritional_values.proteins} />
                  <PropertyBar 
                    label="Liaison" 
          ...
          {filteredFlours.length === 0 && (
            <div className="col-span-full text-center py-12">
              <p className="text-gray-500">Aucune farine privée trouvée. Ajoutez des farines depuis votre tableau de bord.</p>
              <Link 
                to="/dashboard" 
                className="mt-4 inline-block px-4 py-2 bg-green-700 text-white rounded-lg hover:bg-green-600 transition-colors"
              >
            ...
            <div className="bg-white rounded-lg max-w-2xl w-full max-h-[90vh] overflow-y-auto">
              <div className="p-6">
                ...
                <div className="mt-6 space-y-6">
                  <section>
                    <h3 className="text-lg font-semibold text-green-700 mb-3">Valeurs Nutritionnelles</h3>
                  ...
                  <section>
                    <h3 className="text-lg font-semibold text-green-700 mb-3">Propriétés</h3>
                    <div className="grid grid-cols-2 gap-4">
                      <div>
                        <p className="text-sm text-gray-600 mb-1">Profil Protéique</p>
                        <p className="font-medium">{selectedFlour.protein_profile}</p>
                      </div>
                      <div>
                        <p className="text-sm text-gray-600 mb-1">Qualité Protéique</p>
                        <p className="font-medium">{selectedFlour.protein_quality}</p>
                      </div>
                    </div>
                  </section>

                  <section>
                    <h3 className="text-lg font-semibold text-green-700 mb-3">Composition Protéique</h3>
                  ...
                  <section>
                    <h3 className="text-lg font-semibold text-green-700 mb-3">Composition Enzymatique</h3>
                    <div className="space-y-3">
                  ...
                  <section>
                    <h3 className="text-lg font-semibold text-green-700 mb-3">Anti-nutriments</h3>
                    <div className="grid grid-cols-2 gap-4">
                  ...
                  <section>
                    <h3 className="text-lg font-semibold text-green-700 mb-3">Propriétés Mécaniques</h3>
                    <div className="space-y-3">
                  ...
                  <section>
                    <h3 className="text-lg font-semibold text-green-700 mb-3">Conseils d'Utilisation</h3>
                    <div className="bg-green-50 p-4 rounded-lg">
                      <p className="text-sm text-gray-600 mb-2">Ratio Conseillé</p>
