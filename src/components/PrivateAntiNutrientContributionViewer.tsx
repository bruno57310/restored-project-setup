...
function PrivateAntiNutrientContributionViewer() {
  ...
  const fetchContributions = async () => {
    try {
      ...
      // Fetch the anti-nutrient contributions
      ...
      setError(`Error loading private anti-nutrient contributions: ${err instanceof Error ? err.message : 'Unknown error'}`);
    } finally {
      setLoading(false);
    }
  };
  ...
  const downloadCSV = () => {
    ...
    link.download = 'private_anti_nutrient_contributions.csv';
    link.click();
  };
      ...
      <div className="bg-white rounded-lg shadow-md p-6">
        <div className="flex items-center justify-between mb-6">
          <div className="flex items-center gap-4">
            ...
            <h2 className="text-2xl font-bold text-green-800">
              Contributions Anti-Nutriments Privées
            </h2>
          </div>
          <div className="flex items-center gap-4">
            <button
        ...
        <div className="mb-6 bg-blue-50 p-4 rounded-lg">
          <div className="flex items-center gap-2 text-blue-800 mb-2">
            ...
            <h3 className="font-semibold">À propos des contributions anti-nutriments privées</h3>
          </div>
          <p className="text-blue-700 text-sm">
            Cette page affiche les valeurs numériques précises des anti-nutriments pour vos farines privées. 
            Ces données sont utilisées pour calculer l'impact des anti-nutriments dans vos mélanges personnalisés.
...
export default PrivateAntiNutrientContributionViewer;
