...
function PublicEnzymeContributionViewer() {
  ...
  const fetchContributions = async () => {
    try {
      ...
      // Fetch the enzyme contributions from contributionenzymes table
      ...
      setError('Error loading public enzyme contributions');
    } finally {
      setLoading(false);
    }
  };
  ...
  const downloadCSV = () => {
    ...
    link.download = 'public_enzyme_contributions.csv';
    link.click();
  };
      ...
      <div className="bg-white rounded-lg shadow-md p-6">
        ...
        <div className="mb-6 bg-blue-50 p-4 rounded-lg">
          <div className="flex items-center gap-2 text-blue-800 mb-2">
            ...
            <h3 className="font-semibold">À propos des contributions enzymatiques publiques</h3>
          </div>
          <p className="text-blue-700 text-sm">
            Cette page affiche les valeurs précises des enzymes pour les farines du catalogue public. 
            Ces données sont utilisées pour calculer l'impact enzymatique dans vos mélanges.
...
export default PublicEnzymeContributionViewer;
