...
function AntiNutrientContributionViewer() {
  ...
  const fetchContributions = async () => {
    try {
      ...
      setError('Error loading anti-nutrient contributions');
    } finally {
      setLoading(false);
    }
  };
  ...
  const downloadCSV = () => {
    ...
    link.download = 'anti_nutrient_contributions.csv';
    link.click();
  };
      ...
      <div className="bg-white rounded-lg shadow-md p-6">
        ...
        <div className="mb-6 bg-blue-50 p-4 rounded-lg">
          <div className="flex items-center gap-2 text-blue-800 mb-2">
            ...
            <h3 className="font-semibold">À propos des contributions anti-nutriments</h3>
          </div>
          <p className="text-blue-700 text-sm">
            Cette page affiche les valeurs numériques précises des anti-nutriments pour chaque farine. 
...
export default AntiNutrientContributionViewer;
